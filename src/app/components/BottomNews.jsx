export const BottomNews = () => {
  return (
    <div className="w-[100vw]  mt-[60px] h-[220px] pt-10 pb-10 bg-[#4338ca] flex items-start">
      <div className="ml-52 flex flex-col gap-4">
      ...
      <div className="ml-[480px] flex flex-col gap-3 ">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex items-center gap-4">
            <svg
              ...
              fill="none"
            >
              <g clip-path="url(#clip0_2640_3268)">
                <path
      ...
      <div className="ml-[90px] flex flex-col gap-3 text-[14px] font-bold">
        <p>Follow us</p>
